...
| ~~BUG-28~~ | ~~Tooltip wave height values for the first few waypoints from the left are wildly wrong (e.g. 158 m, 307.2 m, 7031 m).~~ — **fixed** (same root cause and fix as BUG-26.) |

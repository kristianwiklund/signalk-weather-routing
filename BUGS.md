...
| # | Description |
|---|---|
| [BUG-136](https://github.com/kristianwiklund/signalk-weather-routing/issues/382) | The legacy wind/wave GRIB path and the new generic GRIB engine return different wave heights at the northern edge of the Baltic_South ICON_EU_EWAM fixture. At lat=59.03125 (59°01'52.500"N), lon ∈ {18.36875 (18°22'07.500"E), 20.16875 (20°10'07.500"E), 21.96875 (21°58'07.500"E)}, for each of the three sampled times (2026-06-06T00:00:00Z, 2026-06-08T12:00:00Z, 2026-06-11T00:00:00Z), the legacy path returns `undefined`; the new generic engine returns wave heights in the range 0.07–0.53 m (e.g. 0.1832246845588078 at lon=18.36875, t=2026-06-06T00:00:00Z). Surfaced 2026-06-21 by the REQ-141 Phase A differential harness. |
| [BUG-137](https://github.com/kristianwiklund/signalk-weather-routing/issues/383) | The legacy ocean-current GRIB path and the new generic GRIB engine return different current vectors near land in the Current_ba fixture. At lat=63.41000000000001 (63°24'36.000"N), lon=21.6665305 (21°39'59.510"E) (Bothnian Sea), for each of the three sampled times (2026-06-14T00:15:00Z, 2026-06-14T12:15:00Z, 2026-06-15T00:00:00Z), the legacy path returns a non-zero current (e.g. `{u:-0.1686952948570151, v:0.00882418155669816}` at 2026-06-14T00:15:00Z); the new generic engine returns `{u:0, v:0}` at the same position and times. Surfaced 2026-06-21 by the REQ-141 Phase A differential harness. |

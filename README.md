...
A graph below the map shows wind speed, wave height, and boat speed along the calculated route over time. The horizontal axis is time-proportional — legs that take longer occupy more horizontal space. Click the graph to expand it to fullscreen. Click again or press Escape to return to normal.

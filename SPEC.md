...
| REQ-37 | The webapp has a "Run test" button that pre-fills start (60°01'37.5"N 19°51'26.9"E), finish (58°24'36.8"N 19°06'20.9"E), and departure time (May 25 06:00 CET = 04:00 UTC) and immediately starts a routing run. A command-line script invokes the same test run with the same fixed parameters. | open |

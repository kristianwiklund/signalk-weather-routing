...
| [REQ-81](https://github.com/kristianwiklund/signalk-weather-routing/issues/151) | ~~Motor fallback triggers below `minBoatSpeed`, not only at polar zero.~~ — superseded by REQ-84 (configurable boat-speed motor threshold) | superseded |
| [REQ-82](https://github.com/kristianwiklund/signalk-weather-routing/issues/152) | ~~Rename `minBoatSpeed` — below threshold sets speed to zero, discard not automatic.~~ — superseded; discard remains the default; exceptions are REQ-83 (wait for wind) and REQ-84 (motor threshold) | superseded |

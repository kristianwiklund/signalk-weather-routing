...
| [REQ-78](https://github.com/kristianwiklund/signalk-weather-routing/issues/139) | Wind arrow tooltips on the calculated route (both waypoint barbs and leg-midpoint barbs) show the calculated boat speed (knots) alongside wind speed and direction. | open |
